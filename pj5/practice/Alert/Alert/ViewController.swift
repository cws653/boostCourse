...
class ViewController: UIViewController {
    ...
    @IBAction func touchUpShowActionSheetButton(_ sender: UIButton) {        self.showAlertController(style: UIAlertController.Style.actionSheet)
    }
    ...
    func showAlertController (style: UIAlertController.Style) {
        ...
        alertController.addTextField { (field: UITextField) in field.placeholder = "플레이스 홀더"
